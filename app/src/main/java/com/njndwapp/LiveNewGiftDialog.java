...
import com.easemob.custommessage.uitls.BaseLiveDialogFragment;
import com.easemob.custommessage.uitls.DemoConstants;
import com.easemob.custommessage.uitls.GiftListRecyclerAdapter;
import com.easemob.custommessage.uitls.HorizontalPageLayoutManager;
import com.easemob.custommessage.uitls.LiveDataBus;
import com.easemob.custommessage.uitls.OnConfirmClickListener;
import com.easemob.custommessage.uitls.OnItemClickListener;
import com.easemob.custommessage.uitls.PagingScrollHelper;
import com.easemob.custommessage.uitls.TestGiftRepository;
                ...
                .observe(this, new Observer<UserBalaceInfo>() {
                    ...
                    public void onChanged(@Nullable UserBalaceInfo rootInfo) {
                     if(rootInfo.getCode()==0&&rootInfo.getDetail()!=null){
                         userBalace=(String) rootInfo.getDetail();
