...
public class DemoMsgHelper {
     ...
     * @param callBack
     */
    public void sendTxtMsg(String content, final OnMsgCallBack callBack) {
        final EMMessage message = EMMessage.createTxtSendMessage(content, chatroomId);
     ...
     * @param callBack
     */
    public void sendGiftMsg(String giftId, int num, final OnMsgCallBack callBack) {
...
//                DemoHelper.saveGiftInfo(message);
     ...
     * @param callBack
     */
    public void sendLikeMsg(int num, final OnMsgCallBack callBack) {
